...
const CATEGORIES: CategorySeed[] = [
  // ── Football Leagues (enabled) ───────────────────────────────────────────
  {
    ...
    badgeUrl: 'https://r2.thesportsdb.com/images/media/league/badge/facv1u1742998896.png',
    iconKey: 'SportsSoccer', apiSource: 'sports', adapterKey: 'FOOTBALL',
    numSides: 3, sideLabels: ['Home', 'Draw', 'Away'], sortOrder: 0,
    config: { externalLeagueId: '4480' },
  },
  {
  ...
  // ── Football Leagues (coming soon) ───────────────────────────────────────
  {
    ...
    badgeUrl: 'https://r2.thesportsdb.com/images/media/league/badge/vk7isd1598802862.png',
    iconKey: 'SportsSoccer', apiSource: 'sports', adapterKey: 'FOOTBALL',
  ...
  },
  {
    ...
    badgeUrl: 'https://r2.thesportsdb.com/images/media/league/badge/2ikh3a1671782958.png',
    iconKey: 'SportsSoccer', apiSource: 'sports', adapterKey: 'FOOTBALL',
  ...
  },
  {
    ...
    badgeUrl: 'https://r2.thesportsdb.com/images/media/league/badge/mlsr7d1718774547.png',
    iconKey: 'SportsSoccer', apiSource: 'sports', adapterKey: 'FOOTBALL',
  ...
  // ── TheSportsDB Sports (enabled) ─────────────────────────────────────────
  {
    ...
    iconKey: 'SportsBasketball', apiSource: 'sports', adapterKey: 'NBA',
    numSides: 2, sideLabels: ['Home', 'Away'], sortOrder: 20,
    config: { sportQuery: 'Basketball', leagueFilter: 'NBA', externalLeagueId: '4387' },
  },
  {
    ...
    iconKey: 'SportsHockey', apiSource: 'sports', adapterKey: 'NHL',
    numSides: 2, sideLabels: ['Home', 'Away'], sortOrder: 21,
    config: { sportQuery: 'Ice Hockey', leagueFilter: 'NHL', externalLeagueId: '4380' },
  },
  {
    ...
    iconKey: 'SportsFootball', apiSource: 'sports', adapterKey: 'NFL',
    numSides: 2, sideLabels: ['Home', 'Away'], sortOrder: 22,
    config: { sportQuery: 'American Football', leagueFilter: 'NFL', externalLeagueId: '4391' },
  },
  {
    ...
    iconKey: 'SportsMma', apiSource: 'sports', adapterKey: 'MMA',
    numSides: 2, sideLabels: ['Fighter 1', 'Fighter 2'], sortOrder: 23,
    config: { sportQuery: 'Fighting', leagueFilter: 'UFC', externalLeagueId: '4443' },
  },
  ...
  // ── TheSportsDB Sports (coming soon) ─────────────────────────────────────
  {
    ...
    iconKey: 'SportsBaseball', apiSource: 'sports', adapterKey: 'MLB',
  ...
  },
  {
    ...
    iconKey: 'DirectionsCar', apiSource: 'sports', adapterKey: 'F1',
  ...
  },
  {
    ...
    iconKey: 'SportsTennis', apiSource: 'sports', adapterKey: 'TENNIS',
  ...
  },
  {
    ...
    iconKey: 'SportsRugby', apiSource: 'sports', adapterKey: 'RUGBY',
  ...
  },
  {
    ...
    iconKey: 'SportsCricket', apiSource: 'sports', adapterKey: 'CRICKET',
  ...
  },
  {
    ...
    iconKey: 'SportsEsports', apiSource: 'sports', adapterKey: 'ESPORTS',
  ...
  },
  {
    ...
    iconKey: 'SportsMma', apiSource: 'sports', adapterKey: 'BOXING',
  ...
  },
  {
    ...
    iconKey: 'SportsGolf', apiSource: 'sports', adapterKey: 'GOLF',
  ...
  // ── Polymarket Categories (enabled) ──────────────────────────────────────
  {
    ...
    config: { tags: ['Politics', 'Elections', 'Global Elections'], tagIds: ['2', '144', '1597'], minVolume24h: 10000, maxDaysAhead: 1100, matchPriority: 99, subcategories: ['Trump', 'Biden', 'Harris', 'US Election', 'Presidential Election', 'Midterms', 'Primaries', 'Democrats', 'Republicans', 'Government Shutdown', 'Impeachment', 'Congress', 'Senate', 'House', 'Supreme Court', 'Cabinet', 'Mayoral Elections', 'UK', 'France', 'Germany', 'Canada', 'Brazil', 'Venezuela', 'Argentina', 'India', 'Trade War', 'Tariffs', 'Middle East', 'Israel', 'Global Elections', 'Elections'] },
  },
  {
  ...
  },
  {
    ...
    config: { tags: ['Business', 'Commodities', 'Economics', 'Gold', 'Oil', 'Stocks'], tagIds: ['107', '101031', '225', '101589', '309', '604'], minVolume24h: 10000, maxDaysAhead: 60, subcategories: ['Bitcoin', 'Ethereum', 'Solana', 'XRP', 'Crypto', 'MicroStrategy', 'Coinbase', 'Tesla', 'Nvidia', 'Apple', 'Stocks', 'Earnings', 'Indices', 'S&P 500', 'Nasdaq', 'IPOs', 'Acquisitions', 'Oil', 'Gas', 'Gold', 'Silver', 'Commodities', 'Forex', 'Fed', 'Interest Rates', 'Inflation', 'Recession', 'GDP', 'Treasuries', 'Economy', 'Business', 'Tech'] },
  },
  ...
  // ── Polymarket Categories (coming soon) ──────────────────────────────────
  {
    ...
    iconKey: 'Science', apiSource: 'predictions', adapterKey: 'POLYMARKET',
  ...
  },
  {
    ...
    iconKey: 'EmojiEvents', apiSource: 'predictions', adapterKey: 'POLYMARKET',
  ...
  },
  {
    ...
    iconKey: 'Cloud', apiSource: 'predictions', adapterKey: 'POLYMARKET',
  ...
  },
  {
    ...
    iconKey: 'CurrencyBitcoin', apiSource: 'predictions', adapterKey: 'POLYMARKET',
