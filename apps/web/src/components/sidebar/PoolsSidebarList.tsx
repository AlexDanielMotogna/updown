                  ...
                  <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 0.5 }}>
                    <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.75, minWidth: 0, flex: 1 }}>
                      ...
                      {!isSports ? (
                        ...
                        <Box component="img" src={cat.badgeUrl} alt="" sx={{ width: 20, height: 20, objectFit: 'contain', ...(cat.type === 'FOOTBALL_LEAGUE' && { bgcolor: 'rgba(13,18,25,0.92)', borderRadius: '50%', p: '2px' }) }} />
                      ) : isPM && cat?.color ? (
