...
import { CryptoAdmin } from './components/CryptoAdmin';
...
const NAV_GROUPS: { group: string; items: NavEntry[] }[] = [
  ...
  { group: 'Economy', items: [
    ...
    { id: 'crypto', label: 'Crypto Event', Component: CryptoAdmin },
    { id: 'marketing', label: 'Marketing', Component: MarketingAssets },
  ] },
];
