...
export function EditDialog({ cat, isNew, open, parents, onClose, onSave }: {
  cat: Category | null;
  isNew: boolean;
  open: boolean;
  parents: Category[];
