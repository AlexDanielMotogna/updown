  ...
  return markets
    .map((m) => {
      ...
      return {
        ...
        marketCap: md.marketCap != null ? String(md.marketCap) : undefined,
        fullName: md.fullName != null ? String(md.fullName) : undefined,
        contract: md.contract != null ? String(md.contract) : undefined,
      } as Ticker;
    })
