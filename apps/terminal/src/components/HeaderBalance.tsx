...
function BalanceInner() {
  ...
  return (
    <span className="flex h-[38px] min-w-[6.5rem] items-center justify-end gap-1 rounded-md bg-white/[0.06] px-3 text-[0.7rem] font-semibold tabular text-surface-100 sm:text-[0.8rem]" title="HyperLiquid account value (spot + perps)">
